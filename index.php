...
================================================== -->
  <body>
		<nav class="navbar navbar-default navbar-static-top" role="navigation">
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<li><a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=72YWKBWLTSEPQ">Donate</a></li>
					<li class="dropdown">
		...
		<div id="program" class="container-fluid row picture-panel penpal">
			<img src="img/joanna.jpg" alt="Pen Pal Program Photo" class="img-responsive">
			<div class="col-xs-12">
			<!-- Info Box-->
				<div class="info-box sm md lg">
		...
		<div class="container-fluid penpal-after">
			<div class="row">
				<div class="col-xs-12">
					<h1>We are always looking for partners who want to add interdisciplinary depth to their classrooms.	So far, we've connected classrooms in the United States and India.</h1>
				</div>
			</div>
		</div>
		...
		<div class="container-fluid map-piconly row xs sm">
			<img src="img/google_map.jpg" alt="Map Placeholder" class="img-responsive">
		</div>
		...
		<div id="contact" class="container-fluid contact">
			...
			$sendError = "<h3>Oops, looks like something went wrong. Email us at contact@lumened.org with your message instead.</h3>";
